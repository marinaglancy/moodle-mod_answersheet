...
/**
 * Define all the backup steps that will be used by the backup_answersheet_activity_task
 *
...
/**
 * Define the complete answersheet structure for backup, with file and id annotations
 *
 * @package   mod_answersheet
 * @category  backup
 * @copyright 2015 Marina Glancy
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class backup_answersheet_activity_structure_step extends backup_activity_structure_step {
    ...
    protected function define_structure() {
        ...
        // Define data sources.
        $answersheet->set_source_table('answersheet', array('id' => backup::VAR_ACTIVITYID));
