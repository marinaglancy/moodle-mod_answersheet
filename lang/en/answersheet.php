...
$string['answersheet:addinstance'] = 'Add instance of Answersheet';
$string['answersheet:submit'] = 'Submit answers in Answersheet';
$string['answersheet:view'] = 'View Answersheet';
$string['answersheet:viewreports'] = 'View reports in Answersheet module';
...
$string['eventattemptcreated'] = 'Attempt started';
$string['eventattemptsaved'] = 'Attempt saved';
$string['eventattemptsubmitted'] = 'Attempt submitted';
$string['explanations'] = 'Explanations';
$string['explanations_help'] = 'Explanations will be shown after the attempt if at least one answer was wrong';
...
$string['questionscount'] = 'Number of questions';
$string['questionscount_help'] = 'Number of questions in the questionnaire and answer sheet';
$string['questionsoptions'] = 'Questions options';
$string['questionsoptions_help'] = 'Comma-separated list of the possible answers for each question';
$string['saveonly'] = 'Save to continue later';
