...
class mod_answersheet_report {
    public static function display($cm, $answersheet) {
        global $OUTPUT;
        $attempts = self::get_all_attempts($cm, $answersheet);
        if (!$attempts) {
            return '';
        }
        ...
        foreach ($attempts as $attempt) {
            ...
            $table->data[] = array(fullname($attempt),
    ...
    protected static function get_all_attempts($cm, $answersheet, $completedonly = true) {
        global $DB;
